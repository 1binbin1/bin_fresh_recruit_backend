...
(
    ...
    a_id        VARCHAR(64)  default ''                NOT NULL COMMENT '账号ID',
    a_phone     varchar(64)  default ''                not null comment '手机号',
    a_password  VARCHAR(32)  default ''                NOT NULL COMMENT '密码',
    a_role      INT          default 0                 NOT NULL COMMENT '角色，0-管理员，1-应届生，2-企业',
    a_add       VARCHAR(64)  default ''                NOT NULL COMMENT '添加人ID',
...
(
    id             INT                                    NOT NULL AUTO_INCREMENT COMMENT 'id',
    user_id        VARCHAR(64)  default ''                NOT NULL COMMENT '应届生id',
    resume_id      VARCHAR(64)  default ''                NOT NULL COMMENT '简历id',
    resume_name    varchar(255) default ''                NOT NULL COMMENT '文件名称',
...
(
    id            INT                                    NOT NULL AUTO_INCREMENT COMMENT 'id',
    com_id        VARCHAR(64)  default ''                NOT NULL COMMENT '企业ID',
...
(
    ...
    user_id     VARCHAR(64) default ''                NOT NULL COMMENT '应届生ID',
    com_id      VARCHAR(64) default ''                NOT NULL COMMENT '企业ID',
    job_id      VARCHAR(64) default ''                NOT NULL COMMENT '岗位ID',
    resume_id   VARCHAR(64) default ''                NOT NULL COMMENT '简历ID',
    send_time   DATETIME    default CURRENT_TIMESTAMP NOT NULL COMMENT '投递时间',
...
(
    id            INT                                     NOT NULL AUTO_INCREMENT COMMENT 'id',
    school_id     VARCHAR(64)   default ''                NOT NULL COMMENT '学校ID',
